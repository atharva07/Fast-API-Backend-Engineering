...
"""
async def project_membership_not_found_handler(
        request: Request,
        exc: ProjectMembershipNotFoundError
):
    return JSONResponse(
        status_code=404,
        content= {
...
async def project_membership_already_exists_handler(
        request: Request,
        exc: ProjectMembershipAlreadyExistsError
):
    return JSONResponse(
        status_code=409,
        content= {
